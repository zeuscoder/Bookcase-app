...
public class DropDownMenu extends LinearLayout {
    ...
    private void init(Context mContext){
        ...
        View popWindows = LayoutInflater.from(mContext).inflate(R.layout.common_popupwindow_menu, null);
        ...
        mMenuList = (ListView) popWindows.findViewById(R.id.book_lv_menu);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawable) {
            ...
            for (int i = 0; i < mMenuCount; i++) {
                final RelativeLayout v = (RelativeLayout) LayoutInflater.from(mContext).inflate(R.layout.common_drop_menu_item, null, false);
