package com.zeus.bookcase.app.user.view;
...
import com.zeus.bookcase.app.user.network.HttpStatusCodes;
...
public class ErrorView extends LinearLayout {
    ...
    private void init(AttributeSet attrs, int defStyle, int defStyleRes) {
        ...
        inflater.inflate(R.layout.user__error_view_layout, this, true);
        ...
        try {
            imageRes = a.getResourceId(R.styleable.ErrorView_ev_errorImage, R.mipmap.user__error_view_cloud);
            ...
            retryButtonBackground = a.getResourceId(R.styleable.ErrorView_ev_retryButtonBackground,
                    R.drawable.user__error_view_retry_button_background);
