package com.zeus.bookcase.app.home.view;
...
/*    public FoldableLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void setupView(Context context) {
        ...
        mRootView = LayoutInflater.from(context).inflate(R.layout.home__foldable_layout, this, true);
    ...
    public void foldWithAnimation() {
        if (!mIsAnimating) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                belowShadow = getResources().getDrawable(R.drawable.home__layout_shadow, null);
                aboveShadow = getResources().getDrawable(R.drawable.home__layout_shadow, null);
            } else {
                belowShadow = getResources().getDrawable(R.drawable.home__layout_shadow);
                aboveShadow = getResources().getDrawable(R.drawable.home__layout_shadow);
            }
