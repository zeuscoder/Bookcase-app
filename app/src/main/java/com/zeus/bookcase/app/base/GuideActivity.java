...
import com.zeus.bookcase.app.base.view.IntroArroundView;
import com.zeus.bookcase.app.base.view.IntroBookView;
import com.zeus.bookcase.app.base.view.IntroSunMoonView;
...
public class GuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app__activity_guide_main);
        setUpViews();
    }
    ...
    private void setIndicatorLayout() {
        ...
        for (int i = 0; i < dotsCount; i++) {
            ...
            mIndicatorView[i].setBackgroundResource(R.drawable.app__intro_rounded_cell_gray);
        ...
        mIndicatorView[0].setBackgroundResource(R.drawable.app__intro_rounded_cell_red);
    ...
    private void setPageChangeListener(ViewPager viewPager) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                mIndicatorView[position].setBackgroundResource(R.drawable.app__intro_rounded_cell_red);
            }
    ...
    public class ScreenSlideFragment extends Fragment {
        ...
        private int getLayoutId(int position) {
            int id = 0;
            if (position == 0) {
                id = R.layout.app__activity_intro_first_screen;
            } else if (position == 1) {
                id = R.layout.app__activity_intro_second_screen;
            } else if (position == 2) {
                id = R.layout.app__activity_intro_third_screen;
            }
            return id;
        }
